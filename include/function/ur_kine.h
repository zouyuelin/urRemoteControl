...
namespace ur_Kinematics {
  ...
  void jacobian(const double* q, double* J, double dx = 0.0, double dy = 0.0, double dz = 0.0);

  void inverseK(const double* T, double *sq, double* q_sols, double q6_des, bool vetex = false);
};
